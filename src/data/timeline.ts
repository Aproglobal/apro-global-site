...
export const TIMELINE_STEPS: Step[] = [
  ...
  { day: 29, title: "Factory release", vendor: "DY Innovate", note: "QC completed; units loaded and handed over for delivery.", img: "/timeline/factory-release.jpg" },
  { day: 30, title: "On-site delivery & installation", vendor: "Hanyangsa", note: "Deliver carts; install option kits on site.", img: "/timeline/on-site-delivery.jpg" },
];
