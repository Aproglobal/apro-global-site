...
export default function App() {
  ...
  useEffect(() => {
    // GA init is centralized in index.html + main.tsx
    setupScrollDepth();
    initThemeWatcher();
  ...
  // Scroll to hash on first mount (when navigated via /#id)
  useEffect(() => {
  ...
  // Hide floating CTA when bottom is occupied by Compare mini/pinned bar
  ...
  return (
    <div className="min-h-screen bg-white text-black dark:bg-black dark:text-white">
      ...
      {/* Sticky CTA — auto-hide when compare occupies bottom */}
      {!bottomBlocked && (
        <button
          onClick={() => {
            openLead("Sticky CTA");
