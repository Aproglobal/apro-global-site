...
type ResourceCard = { id: string; title: string; desc: string; href?: string; comingSoon?: boolean; };
...
export default function ResourcesSection() {
  return (
    <section id="resources" className="py-20 bg-zinc-50 text-black dark:bg-zinc-900 dark:text-white scroll-mt-24 md:scroll-mt-28">
