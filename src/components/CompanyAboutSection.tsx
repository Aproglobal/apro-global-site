  ...
  return (
    <section id="about" className="py-20 bg-white text-black dark:bg-black dark:text-white">
      <div className="max-w-6xl mx-auto px-5">
        <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">About the Company</h2>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <article className="rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 bg-white dark:bg-zinc-950">
            ...
            <dl className="mt-3 text-sm space-y-1">
              <div className="grid grid-cols-[120px_1fr] gap-2">
                <dt className="text-zinc-500">Company</dt><dd>{COMPANY.nameEn}</dd>
              </div>
              <div className="grid grid-cols-[120px_1fr] gap-2">
                <dt className="text-zinc-500">CEO</dt><dd>{COMPANY.ceo}</dd>
              </div>
              <div className="grid grid-cols-[120px_1fr] gap-2">
                <dt className="text-zinc-500">Homepage</dt>
                <dd>
                  <a className="underline" href={COMPANY.homepage} target="_blank" rel="noreferrer">
                    {COMPANY.homepage}
                  </a>
                </dd>
              </div>
            ...
            <h4 className="mt-5 font-semibold">Main Product Lines</h4>
          ...
          <article className="rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 bg-white dark:bg-zinc-950">
            ...
            <h4 className="mt-5 font-semibold">Branches & Repair Plant</h4>
