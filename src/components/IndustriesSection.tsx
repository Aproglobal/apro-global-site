...
const INDUSTRIES: Industry[] = [
  ...
  },
  {
    ...
    name: "Resorts & Hotels",
    outcomes: [
      "Premium guest transfer experience",
      "Low-noise night operations",
      "Brandable seating & trims",
    ],
  ...
  },
  {
    ...
    outcomes: [
      "Safe, predictable campus mobility",
      "Low TCO with electric charging",
      "Modular storage for tools & parcels",
    ],
  ...
  },
  {
    ...
    outcomes: [
      "Flexible seating for peak days",
      "Multi-purpose storage for events",
      "Temporary charging layouts",
    ],
...
export default function IndustriesSection() {
  return (
    <section id="industries" className="py-20 bg-white text-black dark:bg-black dark:text-white">
